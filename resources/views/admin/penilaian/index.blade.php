        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Penilaian Tugas Pemrogaman Dasar Kelas X</h3>
    ...
    <section id="basic-list-group">
        <div class="row match-height">
            <div class="col-lg-6 col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Penilaian Tugas 1 : Perkenalan Java</h4>
                    </div>
                    <div class="card-body">
                        <p class="card-text">
                        ...
                        <p>
                            <a href="/admin/detail-penilaian" class="btn btn-primary">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Penilaian Tugas 2 : Perkenalan C++</h4>
                    </div>
                    <div class="card-body">
                        <p class="card-text">
                            <b>slug</b> Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste, fugiat? Error
