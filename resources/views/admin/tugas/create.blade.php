        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Tambah Tugas Pemrogaman Dasar Kelas X</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="first-name-column">No Tugas</label>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="last-name-column">Nama Tugas</label>
                                                <input type="text" id="last-name-column" class="form-control"
                                                    placeholder="Nama Tugas" name="lname-column">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                        ...
                                        <section class="section">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4 class="card-title">Deskripsi Tugas</h4>
                                                </div>
                                                <div class="card-body">
                                                    <div id="full">
