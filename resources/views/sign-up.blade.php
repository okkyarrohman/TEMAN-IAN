        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-md-10">
                <div class="row  justify-content-center align-items-center">
                    <div class="col-md-3">
                        <div class="title">
                            <img src="{{ asset('nonUser/img/logo.png') }}" alt="" width="300"
                                height="320">
                        </div>
                    </div>
                </div>
                <form action="">
                    <div class="card">
                        <div class="row justify-content-center align-items-center">
                            <div class="col-md-6">
                                <input type="text" class="form-control m-3" name=""
                        ...
                        <div class="row justify-content-center align-items-center">
                            <div class="col-md-4 m-3">
                                <button class="btn btn-warning  ms-4">Daftar</button>
                            </div>
                            <div class="col-md-4 m-3">
                                <button class="btn btn-success  ms-4">Next</button>
                            </div>
                        </div>
                    </div>
